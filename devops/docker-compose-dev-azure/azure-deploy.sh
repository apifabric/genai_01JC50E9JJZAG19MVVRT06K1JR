...
resourcename="genai01jc50e9jjzag19mvvrt06k1jr"  # lower case, only
resourcegroup="genai01jc50e9jjzag19mvvrt06k1jr_rg"
...
# git clone https://github.com/apilogicserver/genai01jc50e9jjzag19mvvrt06k1jr.git
# cd genai01jc50e9jjzag19mvvrt06k1jr
...
az group create --name genai01jc50e9jjzag19mvvrt06k1jr_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group genai01jc50e9jjzag19mvvrt06k1jr_rg --sku S1 --is-linux
az container create --resource-group genai01jc50e9jjzag19mvvrt06k1jr_rg --name genai01jc50e9jjzag19mvvrt06k1jr --image apilogicserver/genai01jc50e9jjzag19mvvrt06k1jr:latest --dns-name-label genai01jc50e9jjzag19mvvrt06k1jr --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//genai01jc50e9jjzag19mvvrt06k1jr.westus.azurecontainer.io:5656'
